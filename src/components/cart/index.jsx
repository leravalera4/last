...
//                               borderWidth: "2px",
//                               boxShadow:
//                                 "rgba(0, 0, 0, .2) 15px 28px 25px -18px",
                          ...
                          >
                            ...
                            >
                              {item.items.map((it) => (
                                ...
                                >
                                  {it.val === "Not sold here" ? (
                                    <p style={{ color: "rgb(184, 184, 184)" }}>Not sold here ($0)</p>
                                  ) : it.stock === "Out of Stock" ? (
                                    <p style={{ color: "rgb(225, 37, 27)" }}>Sold Out ($0)</p>
                                  ) : it.quantity > 1 && it.non_member_price == null && it.regprice == null ? (
                                    <p style={{ color: "rgb(225, 37, 27)" }}>
                                      ${it.prices.toFixed(2)}
                                      {it.saleprice != null ? (
                                        <span style={{ color: "rgb(125, 120, 120)", marginLeft: "4px" }}>
                                          (${it.saleprice} ea)
                                        </span>
                                      ) : (
                                  ...
                                  ) : it.quantity > 1 && it.regprice != null && it.stock != "Out of Stock" ? (
                                    <p>
                                      ${it.prices.toFixed(2)}
                                      {it.saleprice != null ? (
                                        <span style={{ color: "rgb(125, 120, 120)", marginLeft: "4px" }}>
                                  ...
                                  ) : it.saleprice != null && it.non_member_price != null && it.regprice == null && it.quantity > 1 ? (
                                    <p style={{ color: "rgb(225, 37, 27)" }}>
                                      ${it.prices.toFixed(2)}
                                      {it.saleprice != null && (
                                        <span style={{ color: "rgb(125, 120, 120)", marginLeft: "4px" }}>
                                    ...
                                    <>
                                      {it.non_member_price != null && it.non_member_price !== 0 && (
                                        <p style={{ color: "rgb(225, 37, 27)" }}>
                                          ${it.non_member_price}
                                        </p>
                                      )}
                                      {it.saleprice !== null && it.saleprice !== 0 && it.non_member_price && (
                                        <div style={{ display: "flex", alignItems: "center" }}>
                                          {it.quantity > 2 && (
                                            <p style={{ color: "rgb(225, 37, 27)", paddingLeft: "4px" }}>
                                              SALE PRICE ${it.non_member_price}
                                            </p>
                                          )}
                                        </div>
                                      )}
                                      {it.regprice != null && it.val != "Not sold here" && it.non_member_price !== 0 && (
                                        <p>${it.regprice}</p>
                                      )}
                                      {it.non_member_price == null && it.regprice == null && (
                                        <p style={{ color: "rgb(225, 37, 27)" }}>${it.saleprice}</p>
                                      )}
                                    </>
                                  )}
                                </li>
