...
const Index = () => {
  ...
  useEffect(() => {
    axios
      .get("https://api.shoppyscan.ca/sale/stores")
  ...
  const handleStoreChange = async (store) => {
    ...
    try {
      const response = await axios.get(
        `https://api.shoppyscan.ca/sale/stores/${store}`
      );
  ...
  const handleCityChange = async (city) => {
    ...
    try {
      const response = await axios.get(
        `https://api.shoppyscan.ca/sale/stores/${selectedStore}/${city}`
      );
                              ...
                              <div className="product-info-container">
                                ...
                                <div className="overlay-container">
                                  {loading ? (
                                    ...
                                    >
                                        {item.brand !== null ? item.brand : <span style={{ opacity: 0 }}>placeholder</span>}
                                    </p>
                                  )}
                                  {loading ? (
                                    <Skeleton width={154} height={12} />
